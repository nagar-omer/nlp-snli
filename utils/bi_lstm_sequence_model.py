from torch.nn import MaxPool1d, Module, Embedding, LSTM, AvgPool1d
...
class SequenceEncoderModel(Module):
    def __init__(self, params: SequenceEncoderParams):
        ...
        self._lstm_layer = LSTM(params.EMBED_dim + params.EMBED_chr_dim, params.LSTM_hidden_dim, params.LSTM_layers,
    ...
    def _calc_attention_coefficients(self):
        ...
        w_hi, w_hf, w_hc, w_ho = self._lstm_layer.weight_hh_l0.chunk(4, 0)
        norm_out_gates = torch.norm(w_hi, dim=1)
